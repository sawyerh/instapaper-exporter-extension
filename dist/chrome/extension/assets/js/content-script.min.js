...
/***/ function(module, exports, __webpack_require__) {
	...
	function scrapePage(parent) {
	  var articles = parent.querySelectorAll('.articles .highlight_item');
	  var nextPage = parent.querySelector('.paginate_older');
	  var progress = document.querySelector('.instapaper-exporter-progress');
	  progress.textContent = 'Exporting highlights (Page ' + page + ')...';

	  for (var i = 0; i < articles.length; i++) {
	    var article = articles[i];
	    var titleNode = article.querySelector('.article_title');
	    var textNode = article.querySelector('.js_highlight_text');
	    var noteNode = article.querySelector('.highlight_comment .comment_text');
	    var linkNode = article.querySelector('.host .js_domain_linkout');
	...
	function scrapeNextPage(url) {
	  page++;
	  var $box = (0, _jquery2.default)('<div />');
	  $box.load(url + ' #main_content', function () {
